...
test('Checkboxes', async({page}) => {
    ...
    //checkbox is visually hidden {Applied force: true to click} instead of click can use check and uncheck
...
test('lists and dropdowns', async({page}) => {
   ...
   //await expect(optionList).toHaveValue("Dark", "Light", "Cosmic", "Corporate");
...
test('dialog box', async({page}) => {
    ...
    await page.getByRole('table').locator("tr", {hasText: "mdo@gmail.com"}).locator('.nb-trash').click();
    await expect(page.locator('table tr').first()).not.toHaveText('mdo@gmai.com')
})
